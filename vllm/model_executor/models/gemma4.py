...
# === Stubs for APIs not in vLLM 0.16.1 ===
import torch
...
class GateLinear(ReplicatedLinear):
    def __init__(self, input_size, output_size, bias=False, out_dtype=None, params_dtype=None, force_fp32_compute=False, prefix=''):
        super().__init__(input_size, output_size, bias=bias, params_dtype=params_dtype, quant_config=None, prefix=prefix)
        self.out_dtype = out_dtype
    def set_out_dtype(self, out_dtype):
        self.out_dtype = out_dtype
    def forward(self, x):
